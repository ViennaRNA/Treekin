...
extern MAT  *m_add(MAT *A,MAT *B,MAT *out);	/* out <- A + B */
extern MAT  *_set_col(MAT *A,unsigned int i,VEC *out,unsigned int j0);
extern VEC  *get_row(MAT *,unsigned int,VEC *);
extern VEC  *get_col(MAT *,unsigned int,VEC *);
...
extern MAT     *Hfactor(MAT *A,VEC *diag1,VEC *diag2);

extern MAT	*makeHQ(MAT *A,VEC *diag1,VEC *diag2,MAT *Qout),
