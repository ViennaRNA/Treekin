...
namespace treekinCastableTypes {
  ...
  public:
    ...
    operator double() {return this->x[0];}
  ...
  public:
    ...
    mpf_real_castable& operator=(const mpf_real_castable& v) {
      if (this != &v) {
    ...
    mpf_real_castable& operator=(const double& v) {
      if(this->__get_mp()->_mp_d != NULL)
    ...
    operator double() {return this->get_d();}
  };
...
namespace std {
  ...
  static treekinCastableTypes::mpreal_castable abs(treekinCastableTypes::mpreal_castable a) {
    return abs((mpfr::mpreal)a);
  }

  static treekinCastableTypes::mpreal_castable pow(treekinCastableTypes::mpreal_castable a, treekinCastableTypes::mpreal_castable b) {
    return pow((mpfr::mpreal)a,(mpfr::mpreal)b);
  }

  static treekinCastableTypes::mpreal_castable sqrt(treekinCastableTypes::mpreal_castable a) {
